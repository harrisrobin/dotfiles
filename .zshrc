...
plugins=(git wd zsh-autosuggestions macos)
...
GIT_AUTHOR_NAME="Harris Robin Kalash"
GIT_COMMITTER_NAME="$GIT_AUTHOR_NAME"
git config --global user.name "$GIT_AUTHOR_NAME"
GIT_AUTHOR_EMAIL="hello@harris.dev"
...
export JAVA_PATH=/opt/apache-maven-3.6.3/bin:$PATH
